...
#SBATCH --workdir=/gscratch/srlab/sr320/analyses/1101
...
--bam -p \
/gscratch/srlab/sr320/analyses/1101/*.bam


/gscratch/srlab/programs/Bismark-0.19.0/bismark_methylation_extractor \
--bedGraph --counts --scaffolds \
--multicore 14 \
/gscratch/srlab/sr320/analyses/1101/*deduplicated.bam
...
find /gscratch/srlab/sr320/analyses/1101/*deduplicated.bam | \
xargs basename -s .bam | \
xargs -I{} /gscratch/srlab/programs/samtools-1.9/samtools \
sort --threads 28 /gscratch/srlab/sr320/analyses/1101/{}.bam \
-o /gscratch/srlab/sr320/analyses/1101/{}.sorted.bam

# Index sorted files for IGV
# The "-@ 16" below specifies number of CPU threads to use.

find /gscratch/srlab/sr320/analyses/1101/*.sorted.bam | \
xargs basename -s .sorted.bam | \
xargs -I{} /gscratch/srlab/programs/samtools-1.9/samtools \
index -@ 28 /gscratch/srlab/sr320/analyses/1101/{}.sorted.bam
