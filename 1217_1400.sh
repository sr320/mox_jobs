...
#SBATCH --workdir=/gscratch/srlab/sr320/analyses/1217b/

export BLASTDB=/gscratch/srlab/blastdbs/ncbi-nr-nt-20181114/
...
-out /gscratch/srlab/sr320/analyses/1217b/Cb-tax-blast.tab \
-max_target_seqs 1 \
-evalue 1e-20 \
